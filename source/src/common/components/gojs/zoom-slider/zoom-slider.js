 ...
 */
export function ZoomSlider(diagram, options) {
  ...
  this._size = 125;
  this._buttonSize = 25;
  this._alignment = go.Spot.BottomLeft;
  this._alignmentFocus = go.Spot.BottomLeft;
  this._orientation = 'horizontal';
  this._opacity = 1.0;
  this._sliderDivClassName = null;
  ...
  if (options !== undefined) {
    ...
    if (options['sliderDivClassName'] !== undefined) this._sliderDivClassName = options['sliderDivClassName'];
  }
...
ZoomSlider.prototype.sliderDivSetup = function () {
  ...
  this._diagramDiv = this._diagramDiv || this._sliderDivClassName
    ? document.getElementsByClassName(this._sliderDivClassName) ? document.getElementsByClassName(this._sliderDivClassName)[0] : null
    : null;
